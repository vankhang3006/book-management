...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-3xl font-semibold text-gray-800 mb-6 text-center">Sửa Thể loại</h1>
        ...
        <form action="{{ route('admin.categories.update', $Category) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="mt-1 p-2 w-full border border-gray-300 rounded" value="{{ $Category->name }}" required>
            </div>
            
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Cập nhật Thể loại</button>
        </form>
    </div>
