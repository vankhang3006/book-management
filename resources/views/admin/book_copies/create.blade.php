...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold mb-6 text-center">Thêm Bản Sao Sách</h1>
        ...
        <form action="{{ route('admin.book_copies.store') }}" method="POST" class="space-y-6 bg-white p-6 rounded shadow">
            @csrf
